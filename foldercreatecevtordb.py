...
# === PARAMETRELER ===
CHUNK_SIZE = 500      # karakter cinsinden chunk boyutu (optimum: 350-500)
CHUNK_OVERLAP = 100    # karakter cinsinden overlap (optimum: 50-100)
TXT_DIR = "rag-docs-tr"    # txt dosyalarının olduğu klasör
CHROMA_PATH = "chroma_db_v2"  # ChromaDB dizini
COLLECTION_NAME = "rag-docs-tr"  # Koleksiyon adı
